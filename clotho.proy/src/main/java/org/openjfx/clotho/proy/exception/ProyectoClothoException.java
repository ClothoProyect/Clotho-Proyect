package org.openjfx.clotho.proy.exception;

public class ProyectoClothoException extends Exception {
private static final long serialVersionUID = -7090518753638026268L;
	...
	public static final int ERROR_LECTURA_FICHERO=6;

	
	
	public ProyectoClothoException() {
		super();
	}
	
	
	public ProyectoClothoException(Exception e, Class<?> clase, int codError) {
		super(e);
		claseOrigen=clase;
