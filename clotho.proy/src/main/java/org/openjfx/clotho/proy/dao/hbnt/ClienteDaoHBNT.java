...
public class ClienteDaoHBNT implements ClienteDAO {
	...
	@Override
	public Cliente obtenerEntidadPorClave(Integer clave) throws ProyectoClothoException {
